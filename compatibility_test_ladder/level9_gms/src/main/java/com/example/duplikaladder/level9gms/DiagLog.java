...
/**
 * The one place Level 9 writes evidence.
 *
 * <p>Every line goes to logcat under a {@code Duplika.GMS*} tag and is also kept in
...
public final class DiagLog {
    ...
    public static final String TAG = "Duplika.GMS";
    public static final String TAG_PACKAGE = "Duplika.GMS.Package";
    public static final String TAG_SERVICE = "Duplika.GMS.Service";
    public static final String TAG_BINDER = "Duplika.GMS.Binder";
    public static final String TAG_INTENT = "Duplika.GMS.Intent";
    public static final String TAG_UID = "Duplika.GMS.UID";
