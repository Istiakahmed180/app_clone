...
| Level 7 fixture imported through file picker | Base + ABI split selected as two files | Multi-select, staged APK set, manifest validation | PARTIAL: files copied; old parser rejected split archive | Not reached in the old-parser run | Not reached | Not reached | Not tested | Not tested | Not yet verified after manifest fallback |
