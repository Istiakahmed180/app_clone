...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get cloneActionInstallGoogleServices => 'Установить сервисы Google';
  ...
  String cloneInstallGoogleServicesMessage(String appName) {
    return '$appName установит сервисы Google Play в этот клон. Данные клона сохранятся. Это может занять несколько секунд.';
  }
  ...
  String pickerHiddenApps(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count приложений на этом устройстве нельзя клонировать, поэтому их нет в списке',
      few:
          '$count приложения на этом устройстве нельзя клонировать, поэтому их нет в списке',
      one:
          '$count приложение на этом устройстве нельзя клонировать, поэтому его нет в списке',
    );
    return '$_temp0';
  }
